...
console.log('%c👋 Welcome to Keerthana\'s Portfolio!', 'color: #6366f1; font-size: 20px; font-weight: bold;');
console.log('%c💼 Looking for a talented developer? Let\'s connect!', 'color: #8b5cf6; font-size: 14px;');
...
document.addEventListener('keydown', (e) => {
    ...
    if (konamiCode.join(',') === konamiPattern.join(',')) {
        ...
        alert('🎉 You found the Easter egg! Here\'s a special message: "Keep coding and stay awesome!" 💻✨');
    }
});
